...
scanSurrsHapMatDf <- function(result, lengthThresh, chromEnds, noHaps=2*length(result$phasingResults), dataFraction=-1, geneticMap=NULL, gDistT=NULL) {
...
surrMatHapDf$id1 <-  floor((surrMatHapDf$id1+1)/2)
surrMatHapDf$id2 <-  floor((surrMatHapDf$id2+1)/2)
