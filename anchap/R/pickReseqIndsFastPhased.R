...
#
# uses the stitching result, so only the aligned IBD sequences contribute to the imputation potential of individuals
#
...
pickReseqIndsFastPhased <- function (stitchingResult=NULL, noPick=noInds, plotPath=NULL, data, noInds=NULL, appFactor=10) {
